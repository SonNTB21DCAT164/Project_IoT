...
function getSensorData(){
  fetch(`http://localhost:3000/historyy?search=${filter.search}&col=${filter.col}&limit=${filter.limit}&skip=${filter.getSkip()}&sorts=${filter.sorts}`)
...
function getSensorCount(){
  fetch(`http://localhost:3000/historyy/count?search=${filter.search}&col=${filter.col}&limit=${filter.limit}&skip=${filter.getSkip()}&sorts=${filter.sorts}`)
  .then(response => response.json())
  .then(data => {
